		...
		try {
			...
			for (int i = 1; i <= 346; i++) {
				Document doc = Jsoup.connect(
						"https://www.menupan.com/restaurant/bestrest/bestrest.asp?page=" + i + "&trec=8655&pt=rt")
						.get();
				...
				for (int j = 0; j < link.size(); j++) {
					try {
						...
						// Elements image=doc2.select("div#id_restphoto_slides ul#id_restphoto_list_ul
						// img");
